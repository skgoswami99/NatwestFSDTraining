...
public class App 
{
    public static void main( String[] args )
    {
        ...
        Address aObj1 = acapctx.getBean("addObj1",Address.class);
        Address aObj2 = acapctx.getBean("addObj2",Address.class);
...
//        By default the scope of object is singleton
        ...
        Address aObj4 = acapctx.getBean("addObj",Address.class);
        aObj4.setAddId(101);
        aObj4.setStreetNo("123 street 123");
        aObj4.setCity("pune");
        aObj4.setCountry("India");

        Address aObj5 = acapctx.getBean("addObj",Address.class);
        aObj5.setAddId(102);

...
name, parameters) {
  ...
  const props = appendOwnerState(elementType, _extends({}, name === 'root' && !rootComponent && !components[name] && internalForwardedProps, name !== 'root' && !components[name] && internalForwardedProps, mergedProps, LeafComponent && {
    as: LeafComponent
  }, {
    ref
  }), finalOwnerState);

...
const AutocompleteWrapper = styled('div', {
  ...
  [`&.${autocompleteClasses.multiple}`]: _extends({
    paddingInlineStart: 0,
    paddingBlockStart: 'calc(var(--_Input-paddingBlock) - max(var(--Autocomplete-wrapper-gap), 0px))',
    ...
    marginInlineStart: 'calc(-1 * min(var(--Autocomplete-wrapper-gap), var(--_Input-paddingBlock)))',

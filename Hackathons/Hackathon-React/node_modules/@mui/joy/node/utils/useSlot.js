...
const _excluded = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"],
  _excluded2 = ["component", "components", "componentsProps"],
...
name, parameters) {
  ...
  const resolvedComponentsProps = (0, _utils2.resolveComponentProps)(componentsProps[name], ownerState);
  ...
  const props = (0, _utils2.appendOwnerState)(elementType, (0, _extends2.default)({}, name === 'root' && !rootComponent && !components[name] && internalForwardedProps, name !== 'root' && !components[name] && internalForwardedProps, mergedProps, LeafComponent && {
    as: LeafComponent
  }, {
    ref
  }), finalOwnerState);
  return [components[name] || elementType, props];
}